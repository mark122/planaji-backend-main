          ...
          <div class="col-lg-12">
            <div class="ud-login-wrapper" style="border-radius: 6px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px;">
              ...
              {{ csrf_field() }}
                    ...
                    <img src="{{asset('assets/images/enterpriselogin/image.svg')}}" alt="Logo" class="mb-4" style="width:40%"/>
                ...
                <div class="ud-form-group">
                  <button style="background: #22ABB2;" type="submit" class="ud-main-btn w-100">Login</button>
                </div>
              </form>
