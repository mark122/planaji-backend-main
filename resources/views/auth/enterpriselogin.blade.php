...
<body style="background: #665499;">
<section class="ud-login" >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="ud-login-wrapper" style="border-radius: 6px; box-shadow: rgb(0 0 0 / 35%) 0px 5px 15px;">
              ...
              {{ csrf_field() }}
                    ...
                    <img src="{{asset('assets/images/enterpriselogin/First2Care_Logo_edited.webp')}}" alt="Logo" class="mb-4" />
                ...
                <div class="ud-form-group">
                  <button style="background: #665499;" type="submit" class="ud-main-btn w-100">Login</button>
                </div>
              </form>
