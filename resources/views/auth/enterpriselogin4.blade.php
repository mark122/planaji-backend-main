...
<head>
 ...
 <meta property="og:image" content="{{asset('assets/images/logo/thumbnail_planaji.png')}}">
  ...
  <!--====== Favicon Icon ======-->
  <link rel="shortcut icon" href="{{asset('assets/images/logo/planontrack.png')}}" type="image/png" />
...
<body style="background: #d9653c;">
<section class="ud-login" >
      <div class="container">
        <div class="row">
          <div class="col-lg-12">
            <div class="ud-login-wrapper" style="border-radius: 6px; box-shadow: rgba(0, 0, 0, 0.35) 0px 5px 15px; background:#5d5b57">
              ...
              {{ csrf_field() }}
                    ...
                    <img src="{{asset('assets/images/enterpriselogin/planontrack.png')}}" alt="Logo" class="mb-4" style="width:40%"/>
                ...
                <div class="ud-form-group">
                  <button style="background: #d9653c;" type="submit" class="ud-main-btn w-100">Login</button>
                </div>
              </form>
              <p class="signup-option" style="color: white">
                Not a member yet? <a style="color: #8d9fff" href="{{ url('/requestdemo')}}">Request Demo</a>
              </p>
            </div>
